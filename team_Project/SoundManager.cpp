...
SoundManager::SoundManager() {
	...
	intro_bgm = Mix_LoadMUS("../../Resources/intro.mp3");
	if (intro_bgm == 0) {
		std::cout << "Mix_LoadMUS(\"intro.mp3\"): " << Mix_GetError() << std::endl;
	}
	stage_bgm = Mix_LoadMUS("../../resources/stage.mp3");
	if (stage_bgm == 0) {
		std::cout << "Mix_LoadMUS(\"stage.mp3\"): " << Mix_GetError() << std::endl;
	}
	ending_bgm = Mix_LoadMUS("../../resources/ending.mp3");
	if (ending_bgm == 0) {
		std::cout << "Mix_LoadMUS(\"ending.mp3\"): " << Mix_GetError() << std::endl;
	}
	gameover_bgm = Mix_LoadMUS("../../resources/gameover.mp3");
	if (gameover_bgm == 0) {
		std::cout << "Mix_LoadMUS(\"gameover.mp3\"): " << Mix_GetError() << std::endl;
	}
	Mix_VolumeMusic(VOLUME);
	btn_click_se = Mix_LoadWAV("../../Resources/button_click.mp3");
	btn_hold_se = Mix_LoadWAV("../../Resources/button_hold.mp3");
	move_se = Mix_LoadWAV("../../Resources/move.mp3");
	player_atk_se = Mix_LoadWAV("../../Resources/player_attack.mp3");
	player_dmg_se = Mix_LoadWAV("../../Resources/player_damaged.mp3");
	monster_atk_se = Mix_LoadWAV("../../Resources/monster_attack.mp3");
	monster_dmg_se = Mix_LoadWAV("../../Resources/monster_damaged.mp3");
